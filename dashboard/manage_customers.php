...
<ul class="nav-mobile animated fadeInDown">
	...
	<li ><a class="activated" href="manage_customers"><i class="fa fa-sitemap"></i> Manage Customers</a></li>
...
<div class="icon">
<i class="fa fa-sitemap"></i><h2 class="top-bar__headline"> Manage Customers</h2>
