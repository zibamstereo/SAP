...
// we check if everything is filled in and perform checks
  ...
  elseif(empty($_POST['phone']))
  {
	...
	elseif(!$usr->validatePhone($_POST['phone']))
		...
		//$res = $usr->editProfile( $_SESSION['user_id'], $_POST['title'], $_POST['full_name'], $_POST['dob'], $_POST['gender'], $_POST['address'], $_POST['city'], $_POST['state'], $_POST['country'], $_POST['phone']);
	$res = $usr->editProfile( $_SESSION['user_id'], $_POST['title'], $_POST['full_name'], $_POST['dob'], $_POST['gender'], $_POST['address'], $_POST['phone'] );
